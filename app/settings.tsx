...
interface Settings {
    ...
    breathingDuration: number; // 1-10 minutes
}
...
const DEFAULT_SETTINGS: Settings = {
    ...
    breathingRate: 6,
    breathingDuration: 5, // 5 minutes default
};
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    <Text style={styles.sectionDescription}>
                        Session length in minutes (1-10 min)
                    </Text>
                    <View style={styles.rateContainer}>
                        <Pressable
                            style={styles.rateButton}
                        ...
                        <Text style={styles.rateValue}>{settings.breathingDuration} min</Text>
                        <Pressable
                            style={styles.rateButton}
                            onPress={() => updateSetting('breathingDuration', Math.min(10, settings.breathingDuration + 1))}
                        >
                            <Ionicons name="add" size={24} color={Colors.text.primary} />
                        </Pressable>
                    </View>
